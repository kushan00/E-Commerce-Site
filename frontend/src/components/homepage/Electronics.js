...
<div class="input-group">
  ...
  <input type="search" class="form-control rounded" placeholder="Search Electronics" aria-label="Search" onChange={event=>{setserachItem(event.target.value)}} 
   ...
   <br></br><br></br>
      <h1 className="text-center mt-3">All Electronics List</h1>
    
 
      {posts.filter((Electronics)=>{
    if(serachItem==""){
      return Electronics
    }else if(Electronics.itemName.toLowerCase().includes(serachItem.toLowerCase())){
      return Electronics
    }
  })
...
<div className="card p-0 overflow-hidden h-100 shadow" >
  ...
  <h4 className="card-title">&nbsp; {Electronics.itemName} </h4>
  <p className="card-title">&nbsp;Brand Name: {Electronics.brandName} </p>
  <p className="card-text">&nbsp; Unit price: {Electronics.unitPrice}</p>
  <p className="card-text">&nbsp;category: {Electronics.category}</p>
  <p className="card-text">&nbsp;Shipping cost: {Electronics.shippingCost}</p>
  <p className="card-text">&nbsp;Qunatity available: {Electronics.quntityAvailable}</p>
